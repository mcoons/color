            ...
            for (let yg = 0; yg <= 1; yg += .1)
                for (let zb = 0; zb <= 1; zb += .1) {
                    ...
                    switch (loopIndex % 20) {
                        ...
                        case 2:
                            mesh = BABYLON.MeshBuilder.CreateSphere("sphere(" + xr + "," + yg + "," + zb + ")", {
                                size: .95
                            }, scene);
                            break;
                        ...
                        case 4:
                            mesh = BABYLON.MeshBuilder.CreateBox("box(" + xr + "," + yg + "," + zb + ")", {
                                size: .65
                            }, scene);
                            break;
                        ...
                        case 5:
                            mesh = BABYLON.MeshBuilder.CreatePolyhedron("poly1", {
                                type: 1,
                                size: .5
                            }, scene);
                            break;
                        ...
                        case 6:
                            mesh = BABYLON.MeshBuilder.CreatePolyhedron("poly2", {
                                type: 2,
                                size: .5
                            }, scene);
                            break;
                        ...
                        case 7:
                            mesh = BABYLON.MeshBuilder.CreatePolyhedron("poly3", {
                                type: 3,
                                size: .5
                            }, scene);
                            break;
                        ...
                        case 8:
                            mesh = BABYLON.MeshBuilder.CreatePolyhedron("poly4", {
                                type: 4,
                                size: .5
                            }, scene);
                            break;
                        ...
                        case 9:
                            mesh = BABYLON.MeshBuilder.CreatePolyhedron("poly5", {
                                type: 5,
                                size: .5
                            }, scene);
                            break;
                        ...
                        case 10:
                            mesh = BABYLON.MeshBuilder.CreatePolyhedron("poly6", {
                                type: 6,
                                size: .5
                            }, scene);
                            break;
                        ...
                        case 11:
                            mesh = BABYLON.MeshBuilder.CreatePolyhedron("poly7", {
                                type: 7,
                                size: .5
                            }, scene);
                            break;
                        ...
                        case 12:
                            mesh = BABYLON.MeshBuilder.CreatePolyhedron("poly8", {
                                type: 8,
                                size: .5
                            }, scene);
                            break;
                        ...
                        case 13:
                            mesh = BABYLON.MeshBuilder.CreatePolyhedron("poly9", {
                                type: 9,
                                size: .5
                            }, scene);
                            break;
                        ...
                        case 14:
                            mesh = BABYLON.MeshBuilder.CreatePolyhedron("poly10", {
                                type: 10,
                                size: .5
                            }, scene);
                            break;
                        ...
                        case 15:
                            mesh = BABYLON.MeshBuilder.CreatePolyhedron("poly11", {
                                type: 11,
                                size: .5
                            }, scene);
                            break;
                        ...
                        case 16:
                            mesh = BABYLON.MeshBuilder.CreatePolyhedron("poly12", {
                                type: 12,
                                size: .5
                            }, scene);
                            break;
                        ...
                        case 17:
                            mesh = BABYLON.MeshBuilder.CreatePolyhedron("poly13", {
                                type: 13,
                                size: .5
                            }, scene);
                            break;
                        ...
                        case 18:
                            mesh = BABYLON.MeshBuilder.CreatePolyhedron("poly14", {
                                type: 14,
                                size: .5
                            }, scene);
                            break;
                        ...
                        default:
                            mesh = BABYLON.MeshBuilder.CreateTorusKnot("tk", {
                                radius: .25,
                                tube: .25
                            }, scene);
                            break;
...
function createGUI() {
    ...
    panelOptionsContainer.onPointerEnterObservable.add(() => {
        panelOptionsContainer.height = '150px'
    });
    panelOptionsContainer.onPointerOutObservable.add(() => {
        panelOptionsContainer.height = '5px'
    });
